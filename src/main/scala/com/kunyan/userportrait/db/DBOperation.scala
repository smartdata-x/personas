...
object DBOperation extends Serializable{
  ...
  val url = "jdbc:mysql://222.73.34.91:3306/personas?user=personas&password=personas&useUnicode=true&characterEncoding=utf8"
  ...
  def batchInsert(columns:Array[String], iterator: Iterator[(String, String,String)]): Unit = {
  ...
  def batchUpdate(columns:Array[String], iterator: Iterator[(String, String,String)]): Unit ={
    var ps: PreparedStatement = null
